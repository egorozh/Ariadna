...
namespace Ariadna.Engine.GeometryCreator
{
    internal sealed class PointFigure : Figure
    {
        ...
        public PointFigure(Point point, GeometryWorkspace workspace) : base(workspace)
        {
            _point = point;
        ...
        public override Geometry GetGeometry() =>
            new EllipseGeometry(Point, Workspace.GeometryCreator.CoordinateSystem.GetGlobalLength(_shape.Width),

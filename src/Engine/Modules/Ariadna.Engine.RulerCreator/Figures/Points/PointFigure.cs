...
namespace AKIM.Engine.TwoD.RulerCreator
{
    internal sealed class PointFigure : Figure
    {
        ...
        public PointFigure(Point point, RulerWorkspace workspace) : base(workspace)
        {
            _point = point;
        ...
        public override Geometry GetGeometry() =>
            new EllipseGeometry(Point, Workspace.RulerCreator.CoordinateSystem.GetGlobalLength(_shape.Width),

...
namespace Ariadna.Engine.PointCreator
{
    internal sealed class PointFigure : Figure
    {
        ...
        public PointFigure(Point point, PointWorkspace workspace) : base(workspace)
        {
            _point = point;
            _shape.AddToCanvas(Workspace.PointCreator.DrawingControl.Canvas);
        ...
        public override Geometry GetGeometry() =>
            new EllipseGeometry(Point, Workspace.PointCreator.CoordinateSystem.GetGlobalLength(_shape.Width),
                Workspace.PointCreator.CoordinateSystem.GetGlobalLength(_shape.Width));

        public override void Update()
        {
            _shape.SetPosition(Workspace.PointCreator.CoordinateSystem.GetCanvasPoint(Point));
        }

        public override void Dispose()
        {
            Workspace.PointCreator.DrawingControl.Canvas.RemoveElements(_shape);
        }
        ...
        {
            Workspace.PointCreator.DrawingControl.Canvas.AddElements(_shape);

...
namespace AKIM.Engine.TwoD.Rotation
{
    internal sealed class PointFigure : Figure
    {
        ...
        public PointFigure(Point point, RotationWorkspace workspace) : base(workspace)
        {
            _point = point;
            _shape.AddToCanvas(Workspace.RotationManager.DrawingControl.Canvas);
        ...
        public override Geometry GetGeometry() =>
            new EllipseGeometry(Point, Workspace.RotationManager.CoordinateSystem.GetGlobalLength(_shape.Width),
                Workspace.RotationManager.CoordinateSystem.GetGlobalLength(_shape.Width));

        public override void Update()
        {
            _shape.SetPosition(Workspace.RotationManager.CoordinateSystem.GetCanvasPoint(Point));
        }

        public override void Dispose()
        {
            Workspace.RotationManager.DrawingControl.Canvas.RemoveElements(_shape);
        }
        ...
        {
            Workspace.RotationManager.DrawingControl.Canvas.AddElements(_shape);

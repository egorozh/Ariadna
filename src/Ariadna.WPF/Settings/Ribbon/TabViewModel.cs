...
internal class TabViewModel : BaseViewModel
{
    ...
    public TabViewModel(UiTabRibbon tabRibbon, RibbonSettingsViewModel mainVm, IReadOnlyList<IFeature> features)
    {
        _mainVm = mainVm;
        _features = features;
        ...
        {
            var groupVm = new GroupViewModel(uiRibbonGroup, mainVm, features);

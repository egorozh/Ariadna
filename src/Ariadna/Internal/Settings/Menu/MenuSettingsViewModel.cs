...
namespace Ariadna
{
    internal class MenuSettingsViewModel : BaseViewModel
    {
        ...
        public MenuSettingsViewModel(AriadnaApp akimApp, ISettings menuSettings)
        {
            _akimApp = akimApp;
        ...
        public void Accept()
        {
            ...
            _akimApp.UiManager.SetNewMenuItems(menus);
        }
        ...
        private void Update()
        {
            ...
            RootMenuItem = new RootItemVm(new UiMenuItem {Header = "Меню"}, this, null, _akimApp)
            {
                IsExpanded = true
            };
            ...
            {
                var item = new MenuItemViewModel(uiMenuItem, this, RootMenuItem, _akimApp);
        ...
        private void AddCommandMenuItem()
        {
            ...
            {
                Header = feature.DefaultMenuProperties?.Header ?? "Новый пункт меню",
                Id = feature.Id
            }, this, SelectedItem, _akimApp);
        ...
        {
            var newMenuItem = new SeparatorItemVm(new UiMenuItem(), this, SelectedItem, _akimApp);
